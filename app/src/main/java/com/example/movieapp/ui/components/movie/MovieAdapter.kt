...
import com.example.core.kit.BaseAdapter
import com.example.core.utils.ext.observe
import com.example.movieapp.R

class  MovieAdapter : BaseAdapter<MovieTv, ItemMovieBinding>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: BaseAdapter.Companion.BaseViewHolder<ItemMovieBinding>, position: Int) {
